...
foreach ($usuarios as $usuario) {
    if ($_SERVER["REQUEST_METHOD"] === "POST" && $_POST['username'] === $usuario['username'] && $_POST['password'] === $usuario['password']) {
       
        $_SESSION['username'] = $usuario['username'];
        $_SESSION['role'] = $usuario['role'];
        $_SESSION['fotoPerfil'] = $_POST['fotoPerfil'];
        ...
        <div class="signin">
            <div class="content text-center">
                ...
                <form method="post" action="login.php">
                    ...
                    <div class="inputBox ">
                        <input class="p-2 m-2" placeholder="Foto de perfil" type="url" name="fotoPerfil" required>
