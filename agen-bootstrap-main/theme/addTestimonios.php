...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare(
        "INSERT INTO testimonis (nom, cognom, testimoni, imatge)
         VALUES (?, ?, ?, ?)"
    );
...
<body>
    ...
    <div class="news-form-container">
        ...
        <form method="POST">
            ...
            <input type="text" name="testimoni" required>

            <label>imatge:</label>
            <input type="text" name="imatge" required>

            <input type="submit" value="Afegir Testimoni">
        </form>
    </div>
