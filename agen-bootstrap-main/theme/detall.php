...
$resultComentarios = $mysqli->query("SELECT * FROM comentaris WHERE id_noticia = $id");
$comentarios = $resultComentarios->fetch_assoc();
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">Noticia</h1>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <h3 class="font-tertiary mb-5"><?= $noticia['titulo'] ?></h3>
        <img src="<?= $noticia['imatge'] ?>" alt="post-thumb" class="img-fluid w-100 mb-3">
        <p class="float-left mr-4"><?= $noticia['autor'] ?></p>
        ...
        <div class="p-5 mb-4">
          ...
          <div class="media border-bottom py-4">
            ...
            <div class="media-body">
              <h5 class="mb-0 text-secondary"><?= $comentarios['id_usuari'] ?></h5>
              <span class="mr-3"><?= $comentarios['data'] ?></span>
              <a href="#" class="btn btn-transparent py-1 px-2 "><i class="ti-share-alt"></i>Contestar</a>
              <p><?= $comentarios['comentari'] ?></p>
            </div>
          </div>
